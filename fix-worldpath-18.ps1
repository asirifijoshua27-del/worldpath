...
# PowerShell's own working directory (what 'cd' changes) is tracked
# separately from .NET's process-wide current directory, which is what
# System.IO.File methods actually use for relative paths. Sync them so
# WriteAllText resolves paths against where you actually are, not
# wherever this terminal window originally launched from.
